...
bool CWalletDB::WriteBestBlock(const CBlockLowlthsr& lowlthsr)
{
    nWalletDBUpdated++;
    return Write(std::string("bestblock"), lowlthsr);
}

bool CWalletDB::ReadBestBlock(CBlockLowlthsr& lowlthsr)
{
    return Read(std::string("bestblock"), lowlthsr);
}
...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("WealthSalvage-wallet");
