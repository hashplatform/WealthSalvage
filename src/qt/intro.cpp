...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WealthSalvage Core"),
     ...
     * override -datadir in the WealthSalvage.conf file in the default data directory
     * (to be consistent with WealthSalvaged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
