...
In order to support loading of multiple wallets in WealthSalvage-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is WealthSalvage.cpp.
...
Changes to WealthSalvage.cpp
----------------------
WealthSalvage.cpp is the entry point into WealthSalvage-qt, and as such, will require some minor modifications to provide hooks for
