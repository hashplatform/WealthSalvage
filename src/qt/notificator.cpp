...
Notifiwlthsr::Notifiwlthsr(const QString& programName, QSystemTrayIcon* trayicon, QWidget* parent) : QObject(parent),
                                                                                                   parent(parent),
...
void Notifiwlthsr::notifyDBus(Class cls, const QString& title, const QString& text, const QIcon& icon, int millisTimeout)
{
    Q_UNUSED(cls);
...
void Notifiwlthsr::notifySystray(Class cls, const QString& title, const QString& text, const QIcon& icon, int millisTimeout)
{
    Q_UNUSED(icon);
...
#ifdef Q_OS_MAC
void Notifiwlthsr::notifyGrowl(Class cls, const QString& title, const QString& text, const QIcon& icon)
{
    ...
    QString growlApp(this->mode == Notifiwlthsr::Growl13 ? "Growl" : "GrowlHelperApp");
...
void Notifiwlthsr::notifyMacUserNotificationCenter(Class cls, const QString& title, const QString& text, const QIcon& icon)
{
...
void Notifiwlthsr::notify(Class cls, const QString& title, const QString& text, const QIcon& icon, int millisTimeout)
{
    switch (mode) {
#ifdef USE_DBUS
    case Freedesktop:
