...
/** Utility functions used by the WealthSalvage Qt UI.
 */
namespace GUIUtil
{
...
// Render WealthSalvage addresses in monospace font
...
// Parse "WealthSalvage:" URI into recipient object, return true on successful parsing
