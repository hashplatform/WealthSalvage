/* src/config/WealthSalvage-config.h.  Generated from WealthSalvage-config.h.in by configure.  */
/* src/config/WealthSalvage-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WealthSalvage_CONFIG_H

#define WealthSalvage_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.WealthSalvage.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "WealthSalvage Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "WealthSalvage Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "WealthSalvage"
