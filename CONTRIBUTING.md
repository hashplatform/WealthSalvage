Contributing to WealthSalvage Core
============================

The WealthSalvage Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WealthSalvage Core project, and is not to be
confused with overall WealthSalvage Network Protocol consensus changes.

Whether a pull request is merged into WealthSalvage Core rests with the project merge
...
Patches that change WealthSalvage consensus rules are considerably more involved than
...
Where a patch set proposes to change the WealthSalvage consensus, it must have been
...
The project leader is the release manager for each WealthSalvage Core release.
