...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WealthSalvage Core WealthSalvage-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  WealthSalvage-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded WealthSalvage transaction") + "\n" +
                               "  WealthSalvage-tx [options] -create [commands]   " + _("Create hex-encoded WealthSalvage transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded WealthSalvage transaction
