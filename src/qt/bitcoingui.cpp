                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WealthSalvage Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WealthSalvage address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and WealthSalvage: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWLTHS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WealthSalvage Core"), this);
    aboutAction->setStatusTip(tr("Show information about WealthSalvage Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WealthSalvage"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WealthSalvage addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WealthSalvage addresses"));
    ...
    openAction->setStatusTip(tr("Open a WealthSalvage: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), "&Help", this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WealthSalvage Core help message to get a list with possible WealthSalvage command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WealthSalvage Core client") + " " + networkStyle->getTitleAddText();
    trayIcon->setToolTip(toolTip);
    trayIcon->setIcon(networkStyle->getAppIcon());
    trayIcon->show();
#endif

    notificator = new Notifiwlthsr(QApplication::applicationName(), trayIcon, this);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WealthSalvage network", "", count));
}
...
{
    QString strTitle = tr("WealthSalvage Core"); // default title
    // Default to information icon
    int nMBoxIcon = QMessageBox::Information;
    int nNotifyIcon = Notifiwlthsr::Information;
    ...
    if (style & CClientUIInterface::ICON_ERROR) {
        ...
        nNotifyIcon = Notifiwlthsr::Critical;
    } else if (style & CClientUIInterface::ICON_WARNING) {
        nMBoxIcon = QMessageBox::Warning;
        nNotifyIcon = Notifiwlthsr::Warning;
    }
    ...
    if (style & CClientUIInterface::MODAL) {
        ...
        notificator->notify((Notifiwlthsr::Class)nNotifyIcon, strTitle, message);
}
