...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop WealthSalvage server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "WealthSalvage server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WealthSalvage features */
        {"WealthSalvage", "masternode", &masternode, true, true, false},
        {"WealthSalvage", "listmasternodes", &listmasternodes, true, true, false},
        {"WealthSalvage", "getmasternodecount", &getmasternodecount, true, true, false},
        {"WealthSalvage", "masternodeconnect", &masternodeconnect, true, true, false},
        {"WealthSalvage", "masternodecurrent", &masternodecurrent, true, true, false},
        {"WealthSalvage", "masternodedebug", &masternodedebug, true, true, false},
        {"WealthSalvage", "startmasternode", &startmasternode, true, true, false},
        {"WealthSalvage", "createmasternodekey", &createmasternodekey, true, true, false},
        {"WealthSalvage", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"WealthSalvage", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"WealthSalvage", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"WealthSalvage", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"WealthSalvage", "getmasternodescores", &getmasternodescores, true, true, false},
        {"WealthSalvage", "mnbudget", &mnbudget, true, true, false},
        {"WealthSalvage", "preparebudget", &preparebudget, true, true, false},
        {"WealthSalvage", "submitbudget", &submitbudget, true, true, false},
        {"WealthSalvage", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"WealthSalvage", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"WealthSalvage", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"WealthSalvage", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"WealthSalvage", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"WealthSalvage", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"WealthSalvage", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"WealthSalvage", "checkbudgets", &checkbudgets, true, true, false},
        {"WealthSalvage", "mnsync", &mnsync, true, true, false},
        {"WealthSalvage", "spork", &spork, true, true, false},
        {"WealthSalvage", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"WealthSalvage", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use WealthSalvaged, or the -server option to WealthSalvage-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> WealthSalvage-cli " + methodname + " " + args + "\n";
}
