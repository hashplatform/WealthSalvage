...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 34888;
        //bnProofOfWorkLimit = ~uint256(0) >> 1; // WealthSalvage starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1* 60; // WealthSalvage: 1 day
        nTargetSpacing = 1 * 60; //WealthSalvage: 1 minute
        nMaturity = 15;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "WealthSalvage";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1538181237;  // Thursday, Saturday, May 5, 2018 8:17:00 PM GNT
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 989848;
	
			
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00000d098ab8539c66e12ee64990d361c54a3d09456761a93aacb4ce52d37659"));
        assert(genesis.hashMerkleRoot == uint256("b684d6d1bf2945d84f52e65de6877d2b3897986e7e74dac8f6a2b9852368a732"));

       vSeeds.push_back(CDNSSeedData("45.77.76.174", "45.77.76.174"));
       vSeeds.push_back(CDNSSeedData("45.63.24.64", "45.63.24.64"));
       vSeeds.push_back(CDNSSeedData("144.202.120.234", "144.202.120.234"));
       vSeeds.push_back(CDNSSeedData("139.180.215.16", "139.180.215.16"));
       vSeeds.push_back(CDNSSeedData("80.240.25.148", "80.240.25.148"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
  //      vSeeds.push_back(CDNSSeedData("testnet.WealthSalvage.io", "testnet.WealthSalvage.io"));         // Single node address
//        vSeeds.push_back(CDNSSeedData("testnet1.WealthSalvage.io", "testnet1.WealthSalvage.io"));       // Single node address
    //    vSeeds.push_back(CDNSSeedData("testnet2.WealthSalvage.io", "testnet2.WealthSalvage.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // WealthSalvage: 1 day
        nTargetSpacing = 1 * 60;        // WealthSalvage: 1 minutes
