...
public:
    ...
    void setZWealthSalvageControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzWLTHS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzWLTHS_clicked();
    void on_pushButtonZWealthSalvageControl_clicked();
