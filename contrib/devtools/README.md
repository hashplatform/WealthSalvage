...
WLTHS-Project/WLTHS repository.
...
Setup
---------
Configuring the github-merge tool for the WLTHS repository is done in the following way:

    git config githubmerge.repository WLTHS-Project/WLTHS
...
A script to optimize png files in the WLTHS
