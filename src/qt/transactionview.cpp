                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received WealthSalvage from zWealthSalvage"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zWealthSalvage"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zWealthSalvage));
